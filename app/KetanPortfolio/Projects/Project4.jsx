...
const tabs = [
  {
    ...
    content: (
      <div className="w-full overflow-hidden relative sm:h-full  rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br to-gray-700 from-black">
        ...
        />
        <Image
          src="/KetanAssets/ReactProjects/PhoneTextUtils.jpg"
          alt="dummy image"
          width="1000"
          height="1000"
  ...
  },
  {
    ...
    content: (
      <div className="w-full overflow-hidden relative sm:h-full   rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br to-gray-700 from-black">
        <p>About Us tab</p>
        <Image
          src="/KetanAssets/ReactProjects/AboutUs.png"
          alt="dummy image"
          width="1000"
          height="1000"
          className="object-cover object-left-top h-[60%]  md:h-[90%] my-10 inset-x-0 w-full rounded-xl mx-auto hidden md:block"
        />
        <Image
          src="/KetanAssets/ReactProjects/PhoneAboutUs.jpg"
          alt="dummy image"
          width="1000"
          height="1000"
          className="object-cover object-left-top h-full  md:h-[90%] my-10 inset-x-0 w-full rounded-xl mx-auto md:hidden"
  ...
  },
  {
    ...
    content: (
      <div className="w-full overflow-hidden relative sm:h-full   rounded-2xl p-10 text-xl md:text-4xl font-bold text-white bg-gradient-to-br to-gray-700 from-black">
        ...
        />
        <Image
          src="/KetanAssets/ReactProjects/PhoneDarkMode.jpg"
          alt="dummy image"
          width="1000"
          height="1000"
          className="object-cover object-left-top h-full  md:h-[90%] my-10 inset-x-0 w-full rounded-xl mx-auto md:hidden"
